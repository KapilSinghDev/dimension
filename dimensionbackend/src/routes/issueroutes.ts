...
export class issueRouter {
  ...
  private getAllIssues = () => {
    this.router.get('/issue/all', authenticateUser, this.issueController.getAllIssue)
  }
  private createIssueRoute = () => {
    this.router.post('/issue/create', authenticateUser, this.issueController.createNewIssue)
  }
  private updateIssueRoute = () => {
    this.router.put('/issue/update', authorise, this.issueController.updateIssue)
  }
